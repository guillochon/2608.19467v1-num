...
We did not rerun geng enumeration (infeasible at these orders). A
maximal-subgroup descent in \(S_{16}\) above T=1556 is **finished**
(`scripts/s16_walk.g`): 32169 classes, 43 twin-free, 0 failed
`MaximalSubgroupClassReps`, ~50 min. All \(2^k\) orbital graphs of those
classes (472 complement-pairs after nauty) have unique minimum \(K_{8,8}\).
That settles the twin-free \(|\mathrm{Aut}|\ge 1556\) case at n=16. We do
**not** prove Conjecture 1 at unrestricted n=16 or n=18. Independently: the
10 primitive groups of degree 16 with \(|G|\ge 1556\) contribute one twin-free
class (order 1920), whose orbital graphs lose to \(K_{8,8}\) by factor ≈ 5338;
twin blow-ups of twin-free bases of order ≤ 7 have unique minimum \(K_{8,8}\).
Has the §5 enumeration been extended to the twin-forcing classes, equivalently
blow-ups of twin-free bases of order 8–15 with \(|\mathrm{Aut}|\ge 1556\)?
